...
document.getElementById('btn2').addEventListener('click', function() {
  ...
  document.getElementById('output2').innerHTML = '<h2>You typed: ' + inputValue + '</h2>';
});
`;

const Library2 = () => {
  const [htmlCode, setHtmlCode] = useState(initialHTML2);
  const [cssCode, setCssCode] = useState(initialCSS2);
  const [jsCode, setJsCode] = useState(initialJS2);
